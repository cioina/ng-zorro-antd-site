...
export const ROUTER_LIST: RouterList = {
  ...
  },
  {
    ...
    "order": 9,
    "hidden": false,
    "description": "设置文字方向（LTR / RTL）。在文档 body 或者 html 标签上设置 dir 属性。引入 Angular CDK bidi 模块在模版中为应用或其后代设置方向。例如对话框（Modal）服务。Angular CDK Bidirectionalitydir - HTML（超文本标记语言） |...",
    "experimental": false
  },
  {
  ...
  },
  {
    ...
    "order": 13,
    "hidden": false,
    "description": "ng-zorro-antd 严格遵循 Semantic Versioning 2.0.0 语义化版本规范。修订版本号：每周末会进行日常 bugfix 更新。（如果有紧急的 bugfix，则任何时候都可发布）次版本号：每月发布一个带有新特性的向下兼容的版本。主版本号：含有破坏性更新和新特性，不在发布周...",
    "experimental": false
  },
  {
