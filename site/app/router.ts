...
export const ROUTER_LIST: RouterList = {
  ...
  },
  {
    ...
    "order": 8,
    "hidden": false,
    "description": "Since v21, NG-ZORRO uses native animation to implement animation effects. You can remove the @angular/animations dependency as needed.NG-ZORRO allows ...",
    "tag": "updated",
    "experimental": false
  },
  {
    ...
    "order": 8,
    "hidden": false,
    "description": "从 v21 版本开始，NG-ZORRO 完全使用 native animation 实现动画效果，你可以按需移除 @angular/animations 依赖。NG-ZORRO 允许开发者关闭动画效果，您可以通过添加对应指令或者配置来设置动画的开关，也可以通过全局配置关闭所有动画。provideNo...",
    "tag": "updated",
    "experimental": false
  },
  {
