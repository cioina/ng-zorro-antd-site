...
export const ROUTER_LIST: RouterList = {
  ...
  },
  {
    ...
    "order": 8,
    "hidden": false,
    "description": "NG-ZORRO 允许开发者关闭动画效果，您可以通过添加对应指令或者配置来设置动画的开关，也可以通过全局配置关闭所有动画。在模块中使用 NoopAnimationsModule 替换 BrowserAnimationsModule。你可以通过 provideNzNoAnimation 来关闭动画。引...",
    "experimental": false
  },
  {
