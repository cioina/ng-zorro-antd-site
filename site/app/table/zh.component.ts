...
import { NzDemoTableCustomColumnComponent } from './custom-column';
...
import { NzDemoTableExpandIconComponent } from './expand-icon';
...
import { NzDemoTableSummaryComponent } from './summary';
...
export default class NzDemoTableZhComponent {
  expanded = false;
